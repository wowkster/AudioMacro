...
1. Download and unzip the <a target="_blank" href="https://github.com/wowkster/AudioMacro/releases/tag/1.0.0">AudioMacro.zip</a> archive into any empty directory
